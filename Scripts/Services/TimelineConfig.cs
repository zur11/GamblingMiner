...
public static class TimelineConfig
{
	...
	// It was 2011 for the Step 16 P16.6 verification run (landing on 2011-03-21 puts Market Birth, live
	// auctions, founded companies and cycling quarterly votes immediately in reach — what checks 1/2/3/7/9
	// need, and ~1.5 in-game years away from a canonical 2009 start). **Restored to 0 on 2026-08-05 at the
	// close of Step 16**, the step14 EB.1 lesson honoured for the third time (step14, P15.8, here).
	// A StatusBar watermark shows for as long as this is non-zero, and changing it either way re-tags the
