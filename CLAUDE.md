...
│   ├── AuctioningCompanyDetails/ # Per-non-miner tracked-donation pool + settlement summary (Step 14 ND.5)
...
│   │   └── AuctioningCompanyDetails (Step 14 ND.5, from Enroll Mode's "Details →") → BlockExplorer
