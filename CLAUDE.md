...
- DEV readout: the **`WorldEconomy`** scene (MainMenu → "World Economy [DEV]", D-ND8.25) — circulation/grants/debt totals, per-party breakdowns, mint/burn event log; ND.8b later adds its company inflow/expansion knobs to the same scene. See `AIHelperFiles/step14-historical-network-population-scheduler-plan.md` §12.4.6e/§12.5.1 and `Documentation/ProjectDesignManual.md` §36.9.
...
│   ├── WorldEconomy/           # SC Monetary Ledger readout [DEV] (Step 14 ND.8c; ND.8b knobs join later)
│   └── Shared/                 # Reusable UI components
│
├── Scripts/                    # Core logic (~50 C# files)
│   ├── Services/               # Autoload singletons (18 services)
...
├── WorldEconomy [DEV]  → Main Menu   (Step 14 ND.8c — SC Monetary Ledger readout; ND.8b inflow/expansion knobs join later)
