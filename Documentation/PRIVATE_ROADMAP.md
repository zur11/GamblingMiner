...
Done when: this research round has actually run (dataset feasibility check for Option A; a first congestion→fee formula sketch for Option B) and a decision — A, B, or a hybrid — is recorded here with its rationale.
