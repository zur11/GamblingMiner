...
**Status**: Design — all 10 open questions resolved (see §6). **This is the active lead plan** (roadmap Steps 1–3, 5 — see `IMPLEMENTATION_ROADMAP.md`). Next: Phase 1 (identity) can start immediately; Phase 0 (weight + lottery) precedes Phases 4–5. The companion research doc `historical-blockchain-events-research.md` must be filled before Phases 5–6 are coded.
